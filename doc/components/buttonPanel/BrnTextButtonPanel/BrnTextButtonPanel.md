...
![](./img/SantoTextButtonPanelIntro.png)
...
| popDirection | SantoPopupDirection | 点击更多时弹窗的位置 | 否 | SantoPopupDirection.bottom |

## 四、代码演示

### 效果1：一个按钮

![](./img/SantoTextButtonPanelDemo1.png)
```dart
SantoTextButtonPanel(
  nameList: ['操作1'],
  onTap: (index) {
...
![](./img/SantoTextButtonPanelDemo2.png)
```dart
SantoTextButtonPanel(
...
![](./img/SantoTextButtonPanelDemo3.png)
```dart
SantoTextButtonPanel(
...
![](./img/SantoTextButtonPanelDemo4.png)

#### 更多弹窗展开状态：

![](./img/SantoTextButtonPanelDemo5.png)
