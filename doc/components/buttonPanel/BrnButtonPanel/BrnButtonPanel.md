...
<img src="./img/SantoButtonPanelIntro.png" style="zoom:67%;" />
...
| secondaryButtonList | `List<SantoButtonPanelConfig>` | 支持设置按钮可用状态的次按钮集合，优先级高于secondaryButtonNameList | 否 | 无 |
| horizontalPadding | double | 控件水平方向上的左右padding | 否 | 20 |
| popDirection | SantoPopupDirection | 点击更多按钮时弹窗的方向 | 否 | SantoPopupDirection.bottom |

### 其他数据说明

#### SantoButtonPanelConfig
...
<img src="./img/SantoButtonPanelDemo1.png" style="zoom: 33%;" />
...
<img src="./img/SantoButtonPanelDemo2.png" style="zoom: 33%;" />
...
<img src="./img/SantoButtonPanelDemo3.png" style="zoom:33%;" />
...
<img src="./img/SantoButtonPanelDemo4.png" style="zoom:33%;" />
...
<img src="./img/SantoButtonPanelDemo5.png"  />
...
<img src="./img/SantoButtonPanelDemo6.png" style="zoom:50%;" />
...
SantoButtonPanel(
  ...
  secondaryButtonList: [
    SantoButtonPanelConfig(name: '次按钮1', isEnable: true),
    SantoButtonPanelConfig(name: '次按钮2', isEnable: true),
    SantoButtonPanelConfig(name: '次按钮3', isEnable: true),
    SantoButtonPanelConfig(name: '次按钮4', isEnable: true),
