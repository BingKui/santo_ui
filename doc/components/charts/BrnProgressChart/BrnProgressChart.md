...
![](./img/SantoProgressChartIntro.png)
...
| santoProgressIndicatorBuilder | SantoProgressIndicatorBuilder | 自定义进度条上面的Widget，默认显示为文本 | 否 | null |
...
![](./img/SantoProgressChartDemo1.png)
```dart
SantoProgressChart(  
  key: UniqueKey(),  
  width: 200,  
