...
<img src="./img/SantoProgressBarChartIntro1.png" style="zoom:50%;" /> 
<br/>
<img src="./img/SantoProgressBarChartIntro2.png" style="zoom:50%;" /> 
...
| barBundleList | `List<SantoProgressBarBundle>` | 柱形数据 | 是 |  |
...
| barChartSelectCallback | SantoProgressBarChartSelectCallback | 选中柱状图时候的回调 | 否 |  |
...
SantoProgressBarBundle 一组数据中单个柱状的配置
...
<img src="./img/SantoProgressBarChartDemo1.png" style="zoom:50%;" />
...
<img src="./img/SantoProgressBarChartDemo2.png" style="zoom:50%;" />
