...
![image-20211031165613809](./img/SantoSelectTagIntro.png) 
...
SantoSelectTag({
  ...
  this.themeData ??= SantoTagConfig();
  this.themeData = SantoThemeConfigurator.instance
      .getConfig(configId: this.themeData!.configId)
      .tagConfig
      .merge(this.themeData);
  this.themeData = this.themeData!.merge(SantoTagConfig(
      tagBackgroundColor: this.tagBackgroundColor,
      tagTextStyle: SantoTextStyle.withStyle(this.tagTextStyle),
      selectTagTextStyle: SantoTextStyle.withStyle(this.selectedTagTextStyle),
...
| themeData | SantoTagConfig? | 主题定制属性 | 否 |  |
...
![image-20211031170415653](./img/SantoSelectTagDemo1.png) 
...
![image-20211031171122941](./img/SantoSelectTagDemo2.png) 
...
![image-20211031171429265](./img/SantoSelectTagDemo3.png) 
...
![image-20211031171534507](./img/SantoSelectTagDemo4.png) 
...
![image-20211031171809995](./img/SantoSelectTagDemo5.png) 
