...
## 一、效果总览
![](./img/SantoMiddleInputDialogIntro1.png)
![](./img/SantoMiddleInputDialogIntro2.png)

## 二、描述

1. 带输入框的Dialog，在SantoDialogManager 基础上封装了输入框功能。
2. 更进一步的细节定制，可使用 [SantoDialog](../widgets/santo-dialog) 实现
...
| themeData | SantoDialogConfig | 主题定制配置 | 否 | defaultDialogConfig |
