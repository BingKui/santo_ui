---
title: SantoScrollableTextDialog
group:
  title: Dialog
  order: 10
---

# SantoScrollableTextDialog

纯文本 Dialog 超过定高可滚动

## 一、效果总览

<img src="./img/SantoScrollableTextDialogDemo1.png" style="zoom: 67%;" />
<img src="./img/SantoScrollableTextDialogDemo2.png" style="zoom:67%;" />
<br />
<img src="./img/SantoScrollableTextDialogDemo3.png" style="zoom:67%;" />
<img src="./img/SantoScrollableTextDialogDemo4.png" style="zoom:67%;" />
...
```dart
const SantoScrollableTextDialog(
      {this.title,
      this.isClose = true,
...
| linksCallback       | SantoHyperLinkCallback? | 富文本链接点击回调   | 否           | 无                |
