---
title: SantoSingleSelectDialog
group:
  title: Dialog
  order: 10
---

# SantoSingleSelectDialog

适用于单选弹窗列表

## 一、效果总览

<img src="./img/SantoSingleSelectDialog.png" style="zoom: 33%;" />
...
| onSubmitClick            | SantoSingleSelectOnSubmitCallback?    | 提交按钮点击的回调                                          | 否           |            |
| onItemClick              | SantoSingleSelectOnItemClickCallback? | item 的点击回调                                             | 否           |            |
