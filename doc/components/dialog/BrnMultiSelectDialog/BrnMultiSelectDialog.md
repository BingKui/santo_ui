---
title: SantoMultiSelectDialog
group:
  title: Dialog
  order: 10
---

# SantoMultiSelectDialog

多选列表

## 一、效果总览

<img src="./img/SantoMultiSelectDialogIntro.png"  /> 

## 二、描述

### 适用场景

多选列表，适用于从页面中部弹出的情况，属于 Dialog。 相似组件有 [SantoMultiSelectListPicker](../widgets/santo-multi-select-list-picker)， 从页面中部弹出。
...
| onSubmitClick        | SantoMultiSelectDialogClickSubmitCallback? | 点击【完成】时回调给外部选中的数据 | 否           |            |
| onItemClick          | SantoMultiSelectDialogOnItemClickCallback? | Item 被点击的回调                  | 否           |            |
...
<img src="./img/SantoMultiSelectDialogDemo1.png" style="zoom:67%;" />
...
<img src="./img/SantoMultiSelectDialogDemo2.png" style="zoom:67%;" />
...
<img src="./img/SantoMultiSelectDialogDemo3.png" style="zoom: 67%;" />
