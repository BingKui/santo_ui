---
title: SantoMultipleBottomButton
group:
  title: Button
  order: 5
---
...
![image-20211031180759161](./img/SantoMultipleBottomButtonIntro.png)
...
| onSelectedButtonTap | Function(SantoMultipleButtonArrowState)? | selectedButtonOnTap', '点击已选的回调，存在三种状态：-1:不可展开（当value为0的时候），0：收起，1：展开 | 否 |  |
| onSelectAll | void Function(bool?)? | 全选的点击回调，不传则不展示多选按钮，回传参数true表示选中全选，false表示取消全选 | 否 |  |
| hasArrow | bool | 已选侧边是否需要小箭头 | 否 | false |
| bottomController | SantoMultipleBottomController? | 暴露给外界设置按钮状态的控制器 | 否 |  |
...
![](./img/SantoMultipleBottomButtonDemo1.png) 
...
![SantoMultipleBottomButtonDemo2](./img/SantoMultipleBottomButtonDemo2.png) 
...
![](./img/SantoMultipleBottomButtonDemo3.png)  
```dart
SantoMultipleBottomButton(
  onSelectedButtonTap: selectedButtonOnTap,
  hasArrow: false,
...
![image-20211031181422524](./img/SantoMultipleBottomButtonDemo4.png) 
