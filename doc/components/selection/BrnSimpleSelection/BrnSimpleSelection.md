---
title: SantoSimpleSelection
group:
  title: Selection
  order: 28
---

# SantoSimpleSelection
...
| onSimpleSelectionChanged | SantoSimpleSelectionOnSelectionChanged | 选择回调 | 是 |  |
...
| themeData | SantoSelectionConfig |筛选项配置类|否||
...
SantoSimpleSelection.radio(
  ...
  onSimpleSelectionChanged: (
    ...
    SantoToast.show(filterParams.map((e) => e.value).toList().join(','), context);
  },
)
```
```dart
