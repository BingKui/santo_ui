...
<img src="./img/SantoGuideIntroForceGuide.png" style="zoom: 33%;" />

#### 弱引导

<img src="./img/SantoGuideIntroSoftGuide.png" style="zoom:33%;" />
...
static Widget Function(StepWidgetParams params) useDefaultTheme(
  {@required List<SantoTipInfoBean> tipInfo,
...
| **参数名**        | **参数类型**                                         | **描述**         | **是否必填** | 默认值                 |
| ----------------- | ---------------------------------------------------- | ---------------- | ------------ | ---------------------- |
| tipInfo           | `List<SantoTipInfoBean>`                               | 提示内容         | 是           | 无                     |
...
<img src="./img/SantoGuideForceDemo.gif" style="zoom:50%;" />
  ...
  _ForceGuideDemoState() {
    ...
    intro = SantoGuide(
      ...
      widgetBuilder: StepWidgetBuilder.useDefaultTheme(
        showClose: false,
        tipInfo: [
          SantoTipInfoBean("标题栏", "这里是标题栏，显示当前页面的名称", ""),
          SantoTipInfoBean("标签组件", "这里是标签组件，你可以动态添加或者删除组件，当你点击后会将结果给你回传", ""),
          SantoTipInfoBean("左边的按钮", "这里是按钮，点击他试试", ''),
          SantoTipInfoBean("右边的按钮", "这里是按钮，点击他试试", ''),
          SantoTipInfoBean("左边的文本 ", "这是一个朴实无华的文本", ''),
          SantoTipInfoBean("右边文本 ", "这是一个枯燥文本", ""),
          SantoTipInfoBean("开始按钮 ", "点击开启引导动画", ''),
        ],
      ),
    );
  }
...
<img src="./img/SantoGuideSoftDemo.gif" style="zoom:50%;" />
