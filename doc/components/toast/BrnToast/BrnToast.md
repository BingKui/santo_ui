...
<img src="./img/santo_toast_intro.png" style="zoom:50%;" />
...
| duration | Duration? | Toast显示时间的长短 | 否 | SantoToast.LENGTH\_SHORT |
| gravity | SantoToastGravity? | Toast显示在顶部还是底部 | 否 | 0：显示在底部 |
...
<img src="./img/santo_toast_normal.png" style="zoom:50%;" />

```dart
SantoToast.show("共找到10932个结果", context, duration: SantoToast.LENGTH_LONG);  
```
###  效果2：Toast/失败

<img src="./img/santo_toast_fail.png" style="zoom:50%;" />
...
<img src="./img/santo_toast_success.png" style="zoom:50%;" />
