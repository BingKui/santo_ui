...
<img src="./img/SantoSwitchTitleDemo1.png" style="zoom:50%;" />
...
2. 标题选中时的颜色，默认是主题色，`SantoThemeConfigurator.instance.getConfig().commonConfig.brandPrimary`。
