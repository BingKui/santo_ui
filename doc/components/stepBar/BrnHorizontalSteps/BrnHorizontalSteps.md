...
<img src="./img/SantoHorizontalSteps1.jpg" style="zoom:50%;" /><img src="./img/SantoHorizontalSteps2.jpg" style="zoom:50%;" /><img src="./img/SantoHorizontalSteps3.jpg" style="zoom:50%;" /><img src="./img/SantoHorizontalSteps4.jpg" style="zoom:50%;" />
...
| --- | --- | --- | --- | --- |
| steps | `List<SantoStep>` 注：SantoStep见下说明 | 步骤条中元素的列表 | 是，最多支持 5 个 |  |
...
| state | SantoStepState? | indexed/doing/complete未进行/正在进行/已完成 |

## 四、代码演示

### 效果1

![](./img/SantoHorizontalSteps5.png)



```dart
 int _index;
  SantoHorizontalStepsManager _stepsManager = SantoHorizontalStepsManager();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: _stepsManager.buildSteps(currentIndex: _index, isCompleted: false, steps: <SantoStep>[
          SantoStep(
  ...
  List<Widget> controlSteps(BuildContext context) {
    ...
    result.add(SantoTextAction("上一步", iconPressed: () {
      _stepsManager.backStep();
    }));

    result.add(SantoTextAction("下一步", iconPressed: () {
