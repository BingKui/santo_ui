...
![](./img/SantoDatePickerTime.png)
<br/>
![](./img/SantoDatePickerYMD.png)
<br/>
![](./img/SantoDatePickerYMDHMS.png)
...
2. 可自定义显示的时间格式。通过 `dateFormat` 参数进行设置，配合`pickerMode`参数使用，参数设置与效果如下表：
   ...
   | dateFormat格式 |     效果     |
   | :------------- | -------------- |
   | **dateFormat**:  'yyyy年,MMMM月,dd日' <br>**pickerMode**: DateTimePickerMode.date, | ![](./img/SantoDatePickerYMD.png) |
   | **format**: 'yyyy年,MM月,dd日,HH时:mm分:ss秒'<br/>**pickerMode**: SantoDateTimePickerMode.datetime, | ![](./img/SantoDatePickerYMDHMS.png) |
   | **format**: 'HH:mm:ss'<br/>**pickerMode**: SantoDateTimePickerMode.time, | ![](./img/SantoDatePickerTime.png) |
...
| pickerMode | SantoDateTimePickerMode | 时间选择组件显示的时间类型 | 否 | SantoDateTimePickerMode.date |
| pickerTitleConfig | SantoPickerTitleConfig | 时间选择组件的主题样式 | 否 | SantoPickerTitleConfig.Default |
...
| themeData | SantoPickerConfig? | picker配置 配置详见SantoPickerConfig | 否 |  |
