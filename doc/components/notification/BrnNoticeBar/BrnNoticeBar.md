...
<img src="./img/SantoNoticeBarIntro1.png" style="zoom: 33%;" />
<br/>
<img src="./img/SantoNoticeBarIntro2.png" style="zoom: 33%;" />
...
class NoticeStyles {
  ...
  static NoticeStyle failWithArrow = NoticeStyle(
      SantoTools.getAssetImage(SantoAsset.ICON_NOTICE_FAIL),
      Color(0xFFFA3F3F),
      Color(0xFFFEEDED),
      SantoTools.getAssetImage(SantoAsset.ICON_NOTICE_ARROW_RED));
  /// 红色+失败+关闭
  static NoticeStyle failWithClose = NoticeStyle(
      SantoTools.getAssetImage(SantoAsset.ICON_NOTICE_FAIL),
      Color(0xFFFA3F3F),
      Color(0xFFFEEDED),
      SantoTools.getAssetImage(SantoAsset.ICON_NOTICE_CLOSE_RED));
}
```
...
<img src="./img/SantoNoticeBarDemo1.png" style="zoom: 50%;" />
...
<img src="./img/SantoNoticeBarDemo2.png" style="zoom:50%;" />
...
<img src="./img/SantoNoticeBarDemo3.png" style="zoom:50%;" />

```dart
SantoNoticeBar(
  content: '这是通知内容',
  textColor: SantoColor.instance.F0Color, ///通知颜色
  backgroundColor: Colors.grey,  ///背景色
  leftWidget: SantoTools.getAssetImage(SantoAsset.ICON_MORE),  ///左侧图标
  rightWidget: SantoTools.getAssetImage(SantoAsset.ICON_MORE), ///右侧图标
  onNoticeTap: () {
    SantoToast.show('点击通知', context);
  },
  onRightIconTap: () {
