...
<img src="./img/SantoRatioInputFormItemIntro.png" style="zoom:50%;" />
...
| type | Stirng | 录入项类型，主要用于录入类型页面框架中 | 否 | SantoInputItemType.textInputRatioType | 外部可根据此字段判断表单项类型 |
...
![](./img/SantoRatioInputFormItemDemo1.png)
...
![](./img/SantoRatioInputFormItemDemo2.png)

```dart
SantoRatioInputFormItem(
  controller: TextEditingController()..text = "1.6",
  prefixIconType: SantoPrefixIconType.TYPE_ADD,
  isRequire: true,
  isEdit: false,
  error: "必填项不能为空",
  title: "车位比",
