...
![](./img/SantoSelectAllTitleIntro.png)
...
| onSelectAll | OnSantoFormSelectAll? | 点击“全选”选中/取消 | 否 | 无 | void Function(int index, bool isSelect) |
...
![](./img/SantoSelectAllTitleDemo1.png)
...
![](./img/SantoSelectAllTitleDemo2.png)
