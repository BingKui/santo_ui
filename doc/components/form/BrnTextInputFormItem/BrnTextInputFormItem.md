...
![](./img/SantoTextInputFormItemIntro.png)
...
| type | Stirng | 录入项类型，主要用于录入类型页面框架中 | 否 | SantoInputItemType.textInputType | 外部可根据此字段判断表单项类型 |
...
![](./img/SantoTextInputFormItemDemo1.png)
```dart
SantoTextInputFormItem(
...
![](./img/SantoTextInputFormItemDemo2.png)
```dart
SantoTextInputFormItem(
  controller: TextEditingController()..text = "300",
...
![](./img/SantoTextInputFormItemDemo3.png)
```dart
SantoTextInputFormItem(
  controller: TextEditingController()..text = "300",
  prefixIconType: SantoPrefixIconType.add,
...
![](./img/SantoTextInputFormItemDemo4.png)
```dart
SantoTextInputFormItem(
  controller: TextEditingController()..text = "300",
  prefixIconType: SantoPrefixIconType.add,
