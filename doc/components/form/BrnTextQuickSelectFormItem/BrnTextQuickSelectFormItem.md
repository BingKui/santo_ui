---
title: SantoTextQuickSelectFormItem
group:
  title: Form
  order: 12
---

# SantoTextQuickSelectFormItem

快速选择类型录入型表单项。

## 一、效果总览

![](./img/SantoTextQuickSelectFormItemIntro.png)
...
| type | Stirng | 录入项类型，主要用于录入类型页面框架中 | 否 | SantoInputItemType.textQuickSelectInputType | 外部可根据此字段判断表单项类型 |
...
![](./img/SantoTextQuickSelectFormItemDemo1.png)
...
![](./img/SantoTextQuickSelectFormItemDemo2.png)
