...
<img src="./img/SantoRangeInputFormItemIntro.png" style="zoom:50%;" />
...
| type | Stirng | 录入项类型，主要用于录入类型页面框架中 | 否 | SantoInputItemType.textRangeInputType | 外部可根据此字段判断表单项类型 |
...
![](./img/SantoRangeInputFormItemDemo1.png)
```dart
SantoRangeInputFormItem(
...
![](./img/SantoRangeInputFormItemDemo2.png)
