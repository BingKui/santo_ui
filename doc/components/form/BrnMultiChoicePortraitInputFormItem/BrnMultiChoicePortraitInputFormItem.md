---
title: SantoMultiChoicePortraitInputFormItem
group:
  title: Form
  order: 12
---

# SantoMultiChoicePortraitInputFormItem

## 一、效果总览

<img src="./img/SantoMultiChoicePortraitInputFormItemIntro.png" style="zoom:50%;" />
...
| type | Stirng | 录入项类型，主要用于录入类型页面框架中 | 否 | SantoInputItemType.multiChoicePortraitInputType | 外部可根据此字段判断表单项类型 |
...
| onChanged | OnSantoFormMultiChoiceValueChanged? | 选项选中状态变化回调 | 否 | 无 |  |
...
<img src="./img/SantoMultiChoicePortraitInputFormItemDemo1.png" style="zoom:50%;" />
...
<img src="./img/SantoMultiChoicePortraitInputFormItemDemo2.png" style="zoom:50%;" />
