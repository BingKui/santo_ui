...
<img src="./img/SantoNormalFormGroupIntro.png" style="zoom:50%;" />
...
| type | String | 录入项类型，主要用于录入类型页面框架中 | 否 | SantoInputItemType.normalGroupType | 外部可用此字段判断表单类型 |
...
<img src="./img/SantoNormalFormGroupDemo1.png" style="zoom:67%;" />
...
<img src="./img/SantoNormalFormGroupDemo2.png" style="zoom:67%;" />
