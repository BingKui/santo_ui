...
![](./img/SantoExpandFormGroupIntro.png)
...
| type | Stirng | 录入项类型，主要用于录入类型页面框架中 | 否 | SantoInputItemType.normalGroupType | 外部可根据此字段判断表单项类型 |
...
<img src="./img/SantoExpandFormGroupDemo1.png" style="zoom:67%;" />
...
<img src="./img/SantoExpandFormGroupDemo2.png" style="zoom:67%;" />
...
<img src="./img/SantoExpandFormGroupDemo3.png" style="zoom:67%;" />
