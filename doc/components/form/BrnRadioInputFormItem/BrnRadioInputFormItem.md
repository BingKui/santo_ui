...
![](./img/SantoRadioInputFormItemIntro.png)
...
| type | Stirng | 录入项类型，主要用于录入类型页面框架中 | 否 | SantoInputItemType.radioInputType | 外部可根据此字段判断表单项类型 |
...
| onChanged | OnSantoFormRadioValueChanged? | 用户在选项间切换时调用 | 否 | 无 | void Function(String oldStr, String newStr) |
...
![](./img/SantoRadioInputFormItemDemo1.png)
```dart
SantoRadioInputFormItem(
  title: "自然到访保护期",
  options: [
  ...
  onChanged: (oldValue, newValue) {
    SantoToast.show("点击触发回调${oldValue}_${newValue}_onChanged", context);
  },
),
```
...
![](./img/SantoRadioInputFormItemDemo2.png)
```dart
SantoRadioInputFormItem(
...
![](./img/SantoRadioInputFormItemDemo3.png)
```dart
SantoRadioInputFormItem(
...
![](./img/SantoRadioInputFormItemDemo4.png)
```dart
