---
title: SantoStepInputFormItem
group:
  title: Form
  order: 12
---

# SantoStepInputFormItem

## 一、效果总览

<img src="./img/SantoStepInputFormItemIntro.png" style="zoom:50%;" />
...
| type | Stirng | 录入项类型，主要用于录入类型页面框架中 | 否 | SantoInputItemType.textStepInputType | 外部可根据此字段判断表单项类型 |
...
| onChanged | OnSantoFormValueChanged? | 递增值变化回调 | 否 | 无 |  |
...
![](./img/SantoStepInputFormItemDemo1.png)
```dart
SantoStepInputFormItem(
  title: "自然到访保护期",
  subTitle: "这里是副标题",
...
![](./img/SantoStepInputFormItemDemo2.png)
```dart
SantoStepInputFormItem(
