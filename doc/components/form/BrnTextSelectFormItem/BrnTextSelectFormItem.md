...
<img src="./img/SantoTextSelectFormItemIntro.png" style="zoom:50%;" />
...
| type | Stirng | 录入项类型，主要用于录入类型页面框架中 | 否 | SantoInputItemType.textSelectInputType | 外部可根据此字段判断表单项类型 |
...
![](./img/SantoTextSelectFormItemDemo1.png)
```dart
SantoTextSelectFormItem(
  title: "证件类型",
  onTip: () {
...
![](./img/SantoTextSelectFormItemDemo2.png)
```dart
SantoTextSelectFormItem(
...
![](./img/SantoTextSelectFormItemDemo3.png)
...
![](./img/SantoTextSelectFormItemDemo4.png)
