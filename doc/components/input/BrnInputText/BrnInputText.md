...
<img src="./img/SantoInputTextIntro.png" style="zoom: 100%;" />
...
| onTextChange          | SantoInputTextChangeCallback = Function(String input)? | 搜索框输入内容改变时候的回调函数,str 为输入内容              | 否           | 无                   |
| onSubmit              | SantoInputTextSubmitCallback = Function(String input)? | 输入内容点击确定后的回调,str 为输入内容                      | 否           | 空                   |
...
<img src="./img/SantoInputTextDemoFull.png" style="zoom: 33%;" />

<img src="./img/SantoInputTextDemoEmpty.png" style="zoom:33%;" />
