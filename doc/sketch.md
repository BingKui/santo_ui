...
阅读本章内容你将学到如何使用 Santo 配套的 Sketch 文件快速设计页面，并通过定制化标注插件导出可识别组件的设计稿。

在开始之前需要先从 Santo 主页下载 [UI 资源文件](https://santo-ui.example.com/download/sketch)，得到 Sketch 文件和定制标注插件。
