...
import 'package:santo_ui/src/components/gallery/page/santo_gallery_summary_page.dart';
...
class SantoGalleryDetailPage extends StatefulWidget {
  /// 该交互下所有 item 的配置集合
  final List<SantoBasicGroupConfig> allConfig;
  ...
  /// 控制图片查看刷新
  final SantoGalleryController? controller;
  ...
  @override
  _SantoGalleryDetailPageState createState() => _SantoGalleryDetailPageState();
}

class _SantoGalleryDetailPageState extends State<SantoGalleryDetailPage>
    with TickerProviderStateMixin {
  /// title 关联的通知，因为 title 与图片所处的位置关联
  ValueNotifier<String>? _titleNotifier;
  TabController? _tabController;
  List<SantoBasicGroupConfig> _allConfig = <SantoBasicGroupConfig>[];
  int? _curTab;
  int? _curIndex;
  ...
  late SantoTabBarConfig _tabBarConfig;
  ...
  void initState() {
    ...
    // 打平 appbar
    _appBarConfig = SantoThemeConfigurator.instance
        .getConfig(configId: widget.themeData!.configId)
        .appBarConfig
        .merge(widget.themeData!.appbarConfig).merge(SantoAppBarConfig(
    ...
    // 打平 tabBar
    _tabBarConfig = SantoThemeConfigurator.instance
        .getConfig(configId: widget.themeData!.configId)
        .tabBarConfig
        .merge(SantoTabBarConfig(
  ...
  @override
  void didUpdateWidget(SantoGalleryDetailPage oldWidget) {
    ...
    return Scaffold(
      ...
      appBar: SantoAppBar(
        ...
        actions: widget.detailRightAction != null
            ...
            : SantoTextAction(
                SantoIntl.of(context).localizedResource.allPics,
                themeData: _appBarConfig,
                iconPressed: () {
                  if (widget.fromSummary) {
                    ...
                    Navigator.of(context)
                      ...
                      return SantoGallerySummaryPage(
