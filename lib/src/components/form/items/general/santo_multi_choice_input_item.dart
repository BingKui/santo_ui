...
class SantoMultiChoiceInputFormItem extends StatefulWidget {
  ...
  @override
  SantoMultiChoiceInputFormItemState createState() {
    return SantoMultiChoiceInputFormItemState();
  }
}

class SantoMultiChoiceInputFormItemState
    extends State<SantoMultiChoiceInputFormItem> {
