...
class SantoTextInputFormItem extends StatefulWidget {
  /// 录入项的焦点控制对象，主要用于控制焦点
  ...
  /// 录入项前缀图标样式 "添加项" "删除项" 详见 [SantoPrefixIconType] 类
  ...
  State<StatefulWidget> createState() {
    return SantoTextInputFormItemState();
  }
}

class SantoTextInputFormItemState extends State<SantoTextInputFormItem> {
                ...
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: widget.hint?? SantoIntl.of(context).localizedResource.pleaseEnter,
                      counterText: "",
