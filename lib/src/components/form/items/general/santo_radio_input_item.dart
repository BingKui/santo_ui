...
class SantoRadioInputFormItem extends StatefulWidget {
  ...
  @override
  SantoRadioInputFormItemState createState() {
    return SantoRadioInputFormItemState();
  }
}
    ...
    if (options != null && options.isNotEmpty) {
      ...
      for (String? item in options) {
        ...
        double optionWidth = painter.width +
            SantoFormUtil.optionsMiddlePadding(widget.themeData!)!.left +
