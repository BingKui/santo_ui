...
class SantoMultiChoicePortraitInputFormItem extends StatefulWidget {
  ...
  /// 选项选中状态变化回调
  final OnSantoFormMultiChoiceValueChanged? onChanged;
  ...
  @override
  SantoMultiChoicePortraitInputFormItemState createState() {
    return SantoMultiChoicePortraitInputFormItemState();
  }
}

class SantoMultiChoicePortraitInputFormItemState
    extends State<SantoMultiChoicePortraitInputFormItem> {
        ...
        child: SantoCheckbox(
          ...
          onChanged: (value) {
            ...
            setState(() {
              ...
              SantoFormUtil.notifyMultiChoiceStatusChanged(
