...
class SantoTextQuickSelectFormItem extends StatefulWidget {
  ...
  @override
  SantoTextQuickSelectFormItemState createState() {
    return SantoTextQuickSelectFormItemState();
  }
}

class SantoTextQuickSelectFormItemState
  ...
  Widget buildText() {
    if (widget.value != null && widget.value!.isNotEmpty) {
      ...
      return Text(
        ...
        textAlign: TextAlign.end,
        style: SantoFormUtil.getHintTextStyle(widget.themeData!),
      );
    }
  }
}
