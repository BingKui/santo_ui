...
class SantoStepInputFormItem extends StatefulWidget {
  ...
  @override
  SantoStepInputFormItemState createState() {
    return SantoStepInputFormItemState();
  }
}

class SantoStepInputFormItemState extends State<SantoStepInputFormItem> {
  ...
  void _onControllerTextChangedHandleTicker() {
    if (_oldValue != _value) {
      SantoFormUtil.notifyValueChanged(widget.onChanged, context, _oldValue, _value);
      setState(() {});
      _oldValue = _value;
    }
  }
            ...
            child: Row(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      SantoFormUtil.buildPrefixIcon(widget.prefixIconType, widget.isEdit, context,
                          widget.onAddTap, widget.onRemoveTap),
                      SantoFormUtil.buildRequireWidget(widget.isRequire),
                      SantoFormUtil.buildTitleWidget(widget.title, widget.themeData!),
