...
class SantoGeneralFormItem extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return SantoGeneralFormItemState();
  }
}
                      ...
                      child: Container(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            ...
                            if (SantoPrefixIconType.add ==
                                widget.prefixIconType) {
                              if (widget.onAddTap != null) {
                                widget.onAddTap!();
                              }
                            } else if (SantoPrefixIconType.remove ==
                                widget.prefixIconType) {
                          ...
                          child:
                              SantoFormUtil.getPrefixIcon(widget.prefixIconType),
                        ),
                      ),
                    ),
                    Offstage(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              child: Text(
                                widget.tipLabel ?? "",
                                style: SantoFormUtil.getTipsTextStyle(
                                    widget.themeData!),
                              ),
                            ),
                          ],
            ...
            child: Container(
                ...
                child: widget.subTitleWidget ??
                    Text(
                      widget.subTitle ?? "",
                      style:
                          SantoFormUtil.getSubTitleTextStyle(widget.themeData!),
                    )),
          ),
          Offstage(
              offstage: (widget.error.isEmpty),
              child: Container(
                  padding: SantoFormUtil.computeErrorEdgeInsets(
                      widget.prefixIconType, widget.isRequire),
                  child: Text(
                    widget.error,
                    style: SantoFormUtil.getErrorTextStyle(widget.themeData!),
                  )))
        ],
      ),
    );
