...
/// 图标用 [SantoIcon] 渲染,[icon] 传图标名称(取值见 [SantoIcons]),
/// 尺寸固定 [kSantoActionBarIconSize],颜色取 [color](默认基础文字色)。
/// 宽度固定 [kSantoActionBarIconWidth],文案超出以省略号收尾。
///
/// 示例:
/// ```dart
/// SantoActionBarIcon(icon: SantoIcons.headset, text: '客服')
/// SantoActionBarIcon(icon: SantoIcons.cart, text: '购物车', badgeCount: 5)
/// ```
class SantoActionBarIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget iconWidget = SantoBadge(
      count: badgeCount,
      isDot: dot,
      child: SantoIcon(
        icon,
