...
/// 默认位置，头部
const SantoDashedLinePosition _normalPosition = SantoDashedLinePosition.leading;

/// 虚线分割线
class SantoDashedLine extends StatelessWidget {
  ...
  final SantoDashedLinePosition position;
...
class SantoDashedPainter extends CustomPainter {
  /// 虚线方向
  final Axis axis;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (this.axis == Axis.horizontal) {
      ...
      double height = 0;
      if (this.position == SantoDashedLinePosition.leading) {
        // 头部
