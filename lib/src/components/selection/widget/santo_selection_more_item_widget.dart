...
class SantoMoreSelectionWidget extends StatefulWidget {
  //entity 是商圈、钥匙等
  ...
  @override
  _SantoMoreSelectionWidgetState createState() => _SantoMoreSelectionWidgetState();
}

class _SantoMoreSelectionWidgetState extends State<SantoMoreSelectionWidget> {
  @override
...
class __FilterCommonTypeWidgetState extends State<_FilterCommonTypeWidget> {
  ...
  Widget _buildSingleTag(SantoSelectionEntity entity) {
    bool isDate = entity.filterType == SantoSelectionFilterType.date;

    String? showName;

    if (isDate) {
      if (SantoTools.isEmpty(entity.value)) {
...
class __MoreRangeWidgetState extends State<_MoreRangeWidget> {
  ...
  void initState() {
    ...
    minController.addListener(() {
      if (widget.rangeEntity.filterType != SantoSelectionFilterType.range) {
        return;
      }
  ...
  @override
  Widget build(BuildContext context) {
    if (widget.rangeEntity.filterType == SantoSelectionFilterType.dateRange) {
        ...
        children: <Widget>[
          Expanded(
            child: _buildRangeField(
                SantoIntl.of(context).localizedResource.minValue, minController, minFocusNode, widget.themeData),
          ),
          Container(
//          height: 38,
            alignment: Alignment.center,
          ...
          Expanded(
            child: _buildRangeField(
                SantoIntl.of(context).localizedResource.maxValue, maxController, maxFocusNode, widget.themeData),
          ),
        ],
      );
    }
        ...
        Padding(
          ...
          child: GestureDetector(
            ...
            child: Row(
              ...
              children: <Widget>[
                Expanded(
                  child: Text(_isEmptyCondition() ? SantoIntl.of(context).localizedResource.pleaseChoose : _getCondition(),
