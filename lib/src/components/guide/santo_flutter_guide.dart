...
part 'santo_step_widget_builder.dart';

part 'santo_step_widget_params.dart';

part 'santo_throttling.dart';

class SantoTipInfoBean {
  /// 引导标题
  final String title;
  ...
  SantoTipInfoBean(this.title, this.message, this.imgUrl);
}
...
class SantoGuide {
  ...
  /// 强提示下的高亮圆角，默认 BorderRadius.all(Radius.circular(12))
