...
///
/// 该组件需要配合[SantoNumberInfoItemModel]使用，SantoNumberInfoItemModel是每个元素的单独模型。
///
/// 布局规则
...
///
///
class SantoEnhanceNumberCard extends StatelessWidget {

  /// 待展示的信息
  final List<SantoNumberInfoItemModel>? itemChildren;
  ...
  /// the theme config of SantoEnhanceNumberCard
  final SantoEnhanceNumberCardConfig? themeData;

  /// create SantoEnhanceNumberCard
  ...
  Widget build(BuildContext context) {
    SantoEnhanceNumberCardConfig defaultConfig =
        themeData ?? SantoEnhanceNumberCardConfig();

    defaultConfig = defaultConfig.merge(SantoEnhanceNumberCardConfig(
  ...
  Widget _buildItemWidget(
      SantoNumberInfoItemModel model, SantoEnhanceNumberCardConfig config,
      {double? width}) {
    return Column(
  ...
  Widget _getPreWidget(String? preDesc, SantoEnhanceNumberCardConfig config) {
  ...
  Widget _getLastWidget(String? lastDesc, SantoEnhanceNumberCardConfig config) {
...
/// 用来显示强化数据的model
class SantoNumberInfoItemModel {
  ...
  ///icon的事件
  final Function(SantoNumberInfoItemModel)? iconTapCallBack;

  ///icon的样式 可枚举 , 默认为问号
  final SantoNumberInfoIcon numberInfoIcon;
  ...
  SantoNumberInfoItemModel({
    this.number,
    this.title,
    this.numberInfoIcon = SantoNumberInfoIcon.question,
