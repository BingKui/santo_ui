...
/// SantoTimeWidget widget. Can display time picker
// ignore: must_be_immutable
class SantoTimeWidget extends StatefulWidget {
  SantoTimeWidget({
    Key? key,
    this.minDateTime,
    this.maxDateTime,
  ...
  @override
  State<StatefulWidget> createState() => _SantoTimeWidgetState(this.minDateTime,
      this.maxDateTime, this.initDateTime, this.minuteDivider);
}

class _SantoTimeWidgetState extends State<SantoTimeWidget> {
  ...
  _SantoTimeWidgetState(DateTime? minTime, DateTime? maxTime, DateTime? initTime,
      int? minuteDivider) {
    if (minTime == null) {
