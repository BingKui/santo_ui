...
class SantoDateTimeWidget extends StatefulWidget {
  SantoDateTimeWidget({
    Key? key,
    this.minDateTime,
    this.maxDateTime,
  ...
  @override
  State<StatefulWidget> createState() => _SantoDateTimeWidgetState(
      this.minDateTime, this.maxDateTime, this.initDateTime, minuteDivider);
}

class _SantoDateTimeWidgetState extends State<SantoDateTimeWidget> {
  ...
  _SantoDateTimeWidgetState(DateTime? minTime, DateTime? maxTime,
