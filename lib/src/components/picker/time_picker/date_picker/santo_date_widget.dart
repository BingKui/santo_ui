...
class SantoDateWidget extends StatefulWidget {
  SantoDateWidget({
    Key? key,
    this.minDateTime,
    this.maxDateTime,
  ...
  @override
  State<StatefulWidget> createState() => _SantoDateWidgetState(
      this.minDateTime, this.maxDateTime, this.initialDateTime);
}

class _SantoDateWidgetState extends State<SantoDateWidget> {
