...
import 'package:santo_ui/src/components/picker/time_picker/date_range_picker/santo_date_range_picker.dart';
...
class DateTimeFormatter {
  static DateTime? convertStringToDate(String? format, String? date) {
    if (SantoTools.isEmpty(format) || SantoTools.isEmpty(date)) return null;
  ...
  static String generateDateFormat(
      String? dateFormat, SantoDateTimePickerMode pickerMode) {
  ...
  static String generateDateRangePickerFormat(
      String? dateFormat, SantoDateTimeRangePickerMode pickerMode) {
    if (dateFormat != null && dateFormat.isNotEmpty) {
      return dateFormat;
    }
    switch (pickerMode) {
  ...
  static String _formatMonth(
    ...
    List<String> months = SantoIntl.currentResource.months;
  ...
  static String _formatWeek(
    ...
    if (format.contains('EEEE')) {
      ...
      List<String> weeks = SantoIntl.currentResource.weekFullName;
      return format.replaceAll('EEEE', weeks[value - 1]);
    }
    // EEE: the short name of week, e.g. Mon
    List<String> weeks = SantoIntl.currentResource.weekShortName;
