  ...
  static void show(
    ...
    showGeneralDialog(
      ...
      pageBuilder: (BuildContext buildContext, Animation<double> animation,
        ...
        final Widget pageChild = SantoBottomPickerWidget(
...
class SantoBottomPickerWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return SantoBottomPickerWidgetState();
  }
}

class SantoBottomPickerWidgetState extends State<SantoBottomPickerWidget>
  ...
  Widget? _buildConfirmWidget() {
    ...
    if (widget.confirm is Widget) {
      ...
      confirmWidget = _buildDefaultConfirm(SantoIntl.of(context).localizedResource.confirm);
    }
  ...
  Widget? _buildCancelWidget() {
    ...
    if (widget.cancel is Widget) {
      ...
      cancelWidget = _buildDefaultCancel(SantoIntl.of(context).localizedResource.cancel);
    }
    return cancelWidget;
  }
