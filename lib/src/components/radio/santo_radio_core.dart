...
//    Image selectedImage = SantoTools.getAssetImageWithBandColor(
//        widget.radioType == SantoRadioType.single
//            ? SantoAsset.ICON_RADIO_SINGLE_SELECTED
//            : SantoAsset.ICON_RADIO_MULTI_SELECTED);
//    Image unselectedImage = SantoTools.getAssetImage(SantoAsset.ICON_RADIO_UNSELECTED);
//    Image disSelectedImage = SantoTools.getAssetImage(widget.radioType == SantoRadioType.single
//        ? SantoAsset.ICON_RADIO_DISABLE_SINGLE_SELECTED
//        : SantoAsset.ICON_RADIO_DISABLE_MULTI_SELECTED);
//    Image disUnselectedImage = SantoTools.getAssetImage(SantoAsset.ICON_RADIO_DISABLE_UNSELECTED);
...
//          if (widget.radioType == SantoRadioType.single) {
//            // 单选
