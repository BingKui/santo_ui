...
///
/// 相关按钮如下:
///  * [SantoButtonPanel], 小主次按钮组成的横向面板
///  * [SantoMultipleBottomButton], 具备编辑选择状态的底部操作按钮
///  * [SantoTextButtonPanel], 平分可用空间的文本按钮面板
///  * [SantoVerticalIconButton], 小主次按钮组成的横向面板
///
class SantoBottomButtonPanel extends StatelessWidget {
  /// 主按钮的文案
  ...
  /// icon按钮的集合
  final List<SantoVerticalIconButton>? iconButtonList;
  ...
  /// create SantoBottomButtonPanel
  const SantoBottomButtonPanel(
      {Key? key,
