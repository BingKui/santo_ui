...
class SantoTriangleIndicator extends Decoration {
  ...
  factory SantoTriangleIndicator.fromBoxDecoration(BoxDecoration source) {
    ShapeBorder? shape;
    switch (source.shape) {
  ...
  @override
  SantoTriangleIndicator? lerpFrom(Decoration? a, double t) {
    if (a is BoxDecoration) {
      return SantoTriangleIndicator.lerp(
          SantoTriangleIndicator.fromBoxDecoration(a), this, t);
    } else if (a == null || a is SantoTriangleIndicator) {
      return SantoTriangleIndicator.lerp(a as SantoTriangleIndicator?, this, t);
    }
    return super.lerpFrom(a, t) as SantoTriangleIndicator?;
  }

  @override
  SantoTriangleIndicator? lerpTo(Decoration? b, double t) {
    if (b is BoxDecoration) {
      return SantoTriangleIndicator.lerp(
          this, SantoTriangleIndicator.fromBoxDecoration(b), t);
    } else if (b == null || b is SantoTriangleIndicator) {
      return SantoTriangleIndicator.lerp(this, b as SantoTriangleIndicator?, t);
    }
    return super.lerpTo(b, t) as SantoTriangleIndicator?;
  }

  static SantoTriangleIndicator? lerp(
      SantoTriangleIndicator? a, SantoTriangleIndicator? b, double t) {
  ...
  bool operator ==(Object other) {
    ...
    final SantoTriangleIndicator typedOther = other as SantoTriangleIndicator;
...
/// An object that paints a [SantoTriangleIndicator] into a canvas.
class _TriangleDecorationPainter extends BoxPainter {
  ...
  final SantoTriangleIndicator _decoration;
