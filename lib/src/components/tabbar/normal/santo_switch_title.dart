...
class SantoSwitchTitle extends StatefulWidget {
  /// 标题的文案列表
  ...
  @override
  _SantoSwitchTitleState createState() => _SantoSwitchTitleState();
}

class _SantoSwitchTitleState extends State<SantoSwitchTitle>
  ...
  @override
  void didUpdateWidget(SantoSwitchTitle oldWidget) {
