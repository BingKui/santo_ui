...
class _SantoTooltipState extends State<SantoTooltip> {
  ...
  /// 箭头展示方向
  late SantoPopupDirection _popDirection;
        ...
        ? Positioned(
            left: widget.arrowOffset ??
                _left +
                    ...
                    widget.spaceMargin,
            top: _popDirection == SantoPopupDirection.bottom
                ? _top - widget.arrowHeight
                : null,
            bottom: _popDirection == SantoPopupDirection.top
                ? _bottom - widget.arrowHeight
                : null,
            child: CustomPaint(
              size: Size(15.0, widget.arrowHeight),
              painter: _TrianglePainter(
                  isDownArrow: _popDirection == SantoPopupDirection.top,
    ...
    return Positioned(
        ...
        child: Container(
            ...
            constraints: BoxConstraints(
                ...
                maxHeight: _popDirection == SantoPopupDirection.bottom
...
class SantoPopupRoute extends PopupRoute {
  final Duration _duration = Duration(milliseconds: 200);
  Widget child;

  SantoPopupRoute({required this.child});
...
typedef SantoPopupListItemClick = bool Function(int index, String item);
...
class SantoPopupListWindow {
  ...
  static void showButtonPanelPopList(
    ...
    List<String>? data,
    SantoPopupDirection popDirection = SantoPopupDirection.bottom,
    SantoPopupListItemBuilder? itemBuilder,
    ...
    Navigator.push(
        ...
        SantoPopupRoute(
          ...
          isShowCloseIcon: hasCloseIcon,
          offset: offset,
          widget: SantoTools.isEmpty(data)
              ? Container(
  ...
  static double _getMaxWidth(TextStyle textStyle, List<String> data) {
    double maxWidth = 0;
    if (!SantoTools.isEmpty(data)) {
      Size? maxWidthSize;
      for (String entity in data) {
        Size size = SantoTextUtil.textSize(entity, textStyle);
  ...
  static Widget _getTextWidget(SantoPopupListItemBuilder? itemBuilder,
