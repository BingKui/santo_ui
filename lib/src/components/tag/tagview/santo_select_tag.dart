...
class SantoSelectTag extends StatefulWidget {
  /// 展示的标签列表
  ...
  @override
  _SantoSelectTagState createState() => _SantoSelectTagState();
}

class _SantoSelectTagState extends State<SantoSelectTag> {
  List<bool> _tagState = [];
  ...
  @override
  void didUpdateWidget(SantoSelectTag oldWidget) {
