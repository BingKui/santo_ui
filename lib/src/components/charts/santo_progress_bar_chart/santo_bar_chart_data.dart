...
class SantoBarChartScaleStyle {
  ...
  /// create SantoBarChartScaleStyle
  SantoBarChartScaleStyle(
      {required this.title,
      this.titleStyle,
      this.centerSubTitle,
