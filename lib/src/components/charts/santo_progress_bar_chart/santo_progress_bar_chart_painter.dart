...
typedef BarItemEnumeratorCallback = void Function(
    ...
    int barGroupIndex,
    SantoProgressBarItem barItem);

/// 点击柱状数据的回调
typedef SantoProgressBarChartSelectCallback = void Function(
    SantoProgressBarItem? barItem);
...
class SantoProgressBarChartPainter extends CustomPainter {
  /// 柱状图的样式
  ...
  void _prepareData(Canvas canvas, Size size) {
    ...
    if (0 != this.barMaxValue) {
      ...
      this.barBundleList.forEach((SantoProgressBarBundle barbundle) {
        barbundle.barList.forEach((SantoProgressBarItem barItem) {
    ...
    this.barItemEnumerator((int barBundleIndex, SantoProgressBarBundle barBundle,
        int barGroupIndex, SantoProgressBarItem barItem) {
  ...
  void barItemEnumerator(BarItemEnumeratorCallback barItemEnumeratorCallback) {
    ...
    for (int barBundleIndex = 0;
        ...
        barBundleIndex++) {
      SantoProgressBarBundle barBundle = this.barBundleList[barBundleIndex];
      int barNumber = barBundle.barList.length;
      for (int barGroupIndex = 0; barGroupIndex < barNumber; barGroupIndex++) {
        SantoProgressBarItem barItem = barBundle.barList[barGroupIndex];
  ...
  bool? hitTest(Offset position) {
    if (this.santoProgressBarChartSelectCallback != null) {
      this.barItemEnumerator((int barBundleIndex,
          SantoProgressBarBundle barBundle,
          int barGroupIndex,
          SantoProgressBarItem barItem) {
  ...
  @override
  bool shouldRepaint(SantoProgressBarChartPainter oldDelegate) {
    return true;
  }
}
