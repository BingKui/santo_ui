...
class SantoMiddleInputDialog {
  ...
  void _doShow(BuildContext context) {
    ...
    return SantoDialogManager.showConfirmDialog(context,
        cancel: cancelText ?? SantoIntl.of(context).localizedResource.cancel,
        confirm: confirmText ?? SantoIntl.of(context).localizedResource.ok,
        title: title,
