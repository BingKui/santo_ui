...
typedef SantoMultiSelectDialogClickSubmitCallback = bool Function(
    List<MultiSelectItem> data);
typedef SantoMultiSelectDialogOnItemClickCallback = void Function(
...
class SantoMultiSelectDialog extends Dialog {
  /// 是否可关闭  默认true 可关闭
  final bool isClose;
