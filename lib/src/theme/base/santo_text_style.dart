...
class SantoTextStyle {
  ...
  SantoTextStyle.withStyle(TextStyle? style) {
    if (style == null) {
      return;
    }
  ...
  void flatTextStyle(SantoTextStyle? defaultTextStyle) {
  ...
  SantoTextStyle merge(SantoTextStyle? other) {
