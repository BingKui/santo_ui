...
import 'package:santo_ui/src/utils/css/santo_util.dart';
import 'package:flutter/gestures.dart';
import 'package:flutter/material.dart';
import 'package:xml/xml_events.dart' as xml;

/// 超链接的点击回调
typedef SantoHyperLinkCallback = void Function(String text, String? url);
...
class SantoConvert {
  ...
  SantoConvert(
    String cssContent, {
    SantoHyperLinkCallback? linkCallBack,
  ...
  /// 超链接的点击回调
  SantoHyperLinkCallback? _linkCallBack;
              ...
              switch (attr.name) {
                case 'color':
                  textStyle = textStyle.apply(
                    color: SantoConvertUtil.generateColorByString(attr.value),
                  );
                  break;
                case 'weight':
                  FontWeight fontWeight =
                      SantoConvertUtil.generateFontWidgetByString(attr.value);
                  textStyle = textStyle.apply(
                ...
                case 'size':
                  textStyle = textStyle.apply(
                    fontSizeDelta:
                        SantoConvertUtil.generateFontSize(attr.value) - 13,
                  );
                  break;
              }
            });
