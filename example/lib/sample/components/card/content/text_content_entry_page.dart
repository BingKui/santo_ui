...
import 'package:example/sample/components/card/content/santo_two_rich_content_example.dart';
import 'package:example/sample/components/card/content/santo_two_text_content_example.dart';
import 'package:example/sample/components/card/content/santo_two_text_expanded_example.dart';
        ...
        children: [
          ...
          ListItem(
            ...
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(
                builder: (BuildContext context) {
                  return SantoTextRIchContentExample();
                },
              ));
            },
          ),
          ListItem(
            ...
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(
                builder: (BuildContext context) {
                  return SantoTwoRichContentExample();
                },
              ));
            },
          ),
          ...
          ListItem(
            ...
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(
                builder: (BuildContext context) {
                  return SantoTextExpandedContentExample();
                },
              ));
            },
          ),
