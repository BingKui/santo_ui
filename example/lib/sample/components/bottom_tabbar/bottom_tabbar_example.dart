...
class BottomTabbarExampleState extends State<BottomTabbarExample>
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
          ...
          bottomNavigationBar: SantoBottomTabBar(
            // 选中item后的颜色
          ...
          body: ListView(
            children: <Widget>[
              ...
              SantoBottomTabBar(
                ...
                items: <SantoBottomTabBarItem>[
                  SantoBottomTabBarItem(icon: Icon(icons[0]), title: Text(titles[0])),
                ],
              ),
              Padding(
                padding: const EdgeInsets.all(12.0),
              ...
              SantoBottomTabBar(
                ...
                items: <SantoBottomTabBarItem>[
                  SantoBottomTabBarItem(icon: Icon(icons[0]), title: Text("1111111111")),
                  SantoBottomTabBarItem(icon: Icon(icons[0]), title: Text("2222222222")),
                  SantoBottomTabBarItem(icon: Icon(icons[0]), title: Text("3333333333")),
                  SantoBottomTabBarItem(icon: Icon(icons[0]), title: Text("4444444444")),
                  SantoBottomTabBarItem(icon: Icon(icons[0]), title: Text("5555555555")),
                  SantoBottomTabBarItem(icon: Icon(icons[0]), title: Text("6666666666")),
                  SantoBottomTabBarItem(icon: Icon(icons[0]), title: Text("7777777777")),
                  SantoBottomTabBarItem(icon: Icon(icons[0]), title: Text("8888888888")),
                ],
              ),
            ],
          )),
  ...
  List<SantoBottomTabBarItem> _getTabBarItems({int count = 1}) {
    return List<SantoBottomTabBarItem>.generate(
        count,
        (index) => SantoBottomTabBarItem(
              icon: Icon(
                icons[0],
                color: Colors.grey,
              ),
