...
import 'package:example/sample/components/button/santo_small_outline_example.dart';
          ...
          children: <Widget>[
            ...
            ListItem(
              ...
              onPressed: () {
                Navigator.of(context)
                    .push(MaterialPageRoute(builder: (context) {
                  return SantoSmallMainButtonExample();
                }));
              },
            ),
            ListItem(
              ...
              onPressed: () {
                Navigator.of(context)
                    .push(MaterialPageRoute(builder: (context) {
                  return SantoSmallOutlineButtonExample();
                }));
              },
            ),
          ],
