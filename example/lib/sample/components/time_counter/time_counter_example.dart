...
class _TimeCounterExampleState extends State<TimeCounterExample> {
  ...
  /// 自定义格式控制器
  final SantoTimeCounterController _formatController =
      SantoTimeCounterController();
        ...
        child: Column(
          ...
          children: [
            ...
            if (_countdownComplete)
              Center(
                child: Padding(
                  ...
                  child: Text(
                    '倒计时结束！',
                    style: TextStyle(color: Color(0xFFFA3F3F), fontSize: 14),
                  ),
                ),
              ),
            SizedBox(height: 12),
            ...
            Padding(
              padding: EdgeInsets.symmetric(horizontal: 16),
              child: Text(
                '支持 HH:mm:ss、mm:ss、mm:ss:SS 等格式',
                style: TextStyle(fontSize: 13, color: Colors.grey),
              ),
            ),
            SizedBox(height: 16),
            ...
            SizedBox(height: 8),
            _buildFormatItem('HH:mm:ss 格式', 'HH:mm:ss', Duration(hours: 2)),
            SizedBox(height: 8),
